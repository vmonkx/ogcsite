...
const SpecialistItemStyled = styled.div`
  grid-column: span 12;
  max-height: 530px;
  display: flex;
...
function SpecialistItem({ item }) {
  return (
    <SpecialistItemStyled>
      <div className="personal-image">
        <div className="avatar-wrap">
          <GatsbyImage image={item.avatar.urlSharp.childImageSharp.gatsbyImageData} alt={item.name}/>
        </div>
      </div>

      <div className="personal-info">
        <h4 className="personal-name">{item.name}</h4>
